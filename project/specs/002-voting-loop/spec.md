...
- We assume PeerJS data channels are fast enough for low-latency state synchronization.
- We assume all participants have a display name to identify their votes upon reveal.
 current Active Item.
- **RevealStatus**: Boolean state (Hidden/Visible) for the current voting round.
